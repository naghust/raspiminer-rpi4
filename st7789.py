# ST7789 240x240 driver for the Waveshare 1.3" LCD HAT.
# Vendored/adapted from the Waveshare example driver (MIT-style license, see lcd_hardware.py).

import time
import lcd_hardware as config
...
class ST7789(config.RaspberryPi):
    ...
    def ShowImage(self, Image):
        """Write a PIL image to the physical display."""
